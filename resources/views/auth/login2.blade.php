                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">
                                    ...
                                    <img width="50" src="{{ asset('assets/depan/img/logo1.png') }}" alt="">
                                </span>
                                <span class="app-brand-text demo text-body fw-bolder">Stempert</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to the login page 👋</h4>
