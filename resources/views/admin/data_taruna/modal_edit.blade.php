    <!-- Modal -->
    <div class="modal fade" id="basicModal{{ $dt->id }}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Edit Data Taruna</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('data_taruna.update', $dt->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row g-2">
                            <div class="col mb-0">
                                <label for="1" class="form-label">NIT</label>
                                <input type="number" value="{{ $dt->nit }}" name="nit" id="1"
                                    class="form-control" placeholder="Masukan NIT" />
                            </div>
                            <div class="col mb-0">
                                <label for="2" class="form-label">NISN</label>
                                <input type="number" value="{{ $dt->nisn }}" name="nisn" id="2"
                        ...
                        <div class="row g-2">
                            <div class="col mb-0">
                                ...
                                <input type="text" value="{{ $dt->nama }}" name="nama" id="3"
                            ...
                            <div class="col mb-0">
                                ...
                                <select name="kelas" id="defaultSelect" class="form-select">
                                    <option selected value="{{ $dt->kelas }}">{{ $dt->kelas }}</option>
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <select name="kompetensi_keahlian" id="defaultSelect" class="form-select">
                                    <option selected value="{{ $dt->kompetensi_keahlian }}">
                                        {{ $dt->kompetensi_keahlian }}</option>
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <select name="keterangan" id="defaultSelect" class="form-select">
                                    <option value="{{ $dt->keterangan }}" selected>{{ $dt->keterangan }}</option>
