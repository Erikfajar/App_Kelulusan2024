                      ...
                      <div class="row">
                          <div class="col mb-3">
                              ...
                              <select name="kompetensi_keahlian" id="defaultSelect" class="form-select">
                                  ...
                                  <option value="ATPH">Agribisnis Tanaman Pangan & Holtikultura</option>
                                  <option value="APHP">Agribisnis PengolahanHasil Pertanian</option>
                                  <option value="APAT">Agribisnis Perikanan Air Tawar</option>
                                  <option value="ATU">Agribisnis Ternak Unggas</option>
                                  ...
                                  <option value="TLOG">Teknik Logistik</option>
