...
<head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('assets/admin') }}/assets/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            ...
            <a href="#" onclick="history.back(); return false;" class="btn btn-primary">Back to home</a>
            <div class="mt-3">
                <img src="{{ asset('assets/admin') }}/assets/img/illustrations/page-misc-error-light.png"
